...
export default function RegisterForm({ redirectTo }: RegisterFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (nextErrors.email || nextErrors.password) {
      setMessage("Uzupełnij poprawnie formularz rejestracji.");
      return;
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
