...
export default function CreateClubPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col justify-center px-6 py-16 text-slate-900">
      ...
      <h1 className="mt-4 text-4xl font-semibold tracking-tight">Tworzenie klubu</h1>
      <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600">
        Ten ekran będzie rozwinięty w stage 8. Na razie dashboard kieruje tutaj jako punkt startowy dla nowego klubu.
      </p>
